...
- スマホ対応(バーチャルジョイスティック+タッチボタン、画面自動フィット)
...
| 操作 | PC | スマホ |
|---|---|---|
| 移動 | WASD / 矢印キー | 左のジョイスティック |
| 攻撃 | SPACE / J | ⚔ボタン(長押しで連続攻撃) |
| スキル | 1〜4(習得順) | スキルボタン(習得すると出現) |
| 会話・調べる・決定 | E / ENTER | 「はなす/しらべる」ボタン or 画面タップで会話送り |
| 選択肢 | ↑↓ + E | スティック上下 + タップ |
| メニュー | M(閉じる: Esc) | ≡ボタン |
| セーブ | K | 「記録」ボタン |

スマホは横向き推奨。画面サイズに自動フィットします。
